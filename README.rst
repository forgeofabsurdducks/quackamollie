...
:Docker Image: registry.gitlab.com/forge_of_absurd_ducks/quackamollie/quackamollie:0.1rc1
:Build Status:
...
.. code-block:: bash
   ...
   pip install dist/quackamollie-0.1rc1.tar.gz

- Or install it from wheel

.. code-block:: bash

   pip install dist/quackamollie-0.1rc1.whl
...
.. code-block:: bash
   ...
   # or
   pip install "quackamollie==0.1rc1"
...
.. code-block:: bash
   ...
   docker build --network=host -t quackamollie:0.1rc1 .
...
.. code-block:: bash
   ...
   # or
   docker pull registry.gitlab.com/forge_of_absurd_ducks/quackamollie/quackamollie:0.1rc1
...
- Instead of downloading the files locally, we recommend you to run the dedicated docker image or to use `docker compose`
  ...
  .. code-block:: bash
    ...
    registry.gitlab.com/forge_of_absurd_ducks/quackamollie/quackamollie:0.1rc1 \
  ...
  .. code-block:: yaml
    ...
    services:
      quackamollie_db_migration:
        image: registry.gitlab.com/forge_of_absurd_ducks/quackamollie/quackamollie:0.1rc1
